...
$upload_dir = 'img/uploads/file_manager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../img/uploads/file_manager/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../img/uploads/file_manager_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
